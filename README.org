...
- Comprehensive (e.g. tries to cover new versions from the [[https://www.ietf.org/archive/id/draft-ietf-uuidrev-rfc4122bis-10.txt][IETF draft]])
...
UUID versions above version 5 are based on version 10 of the [[https://www.ietf.org/archive/id/draft-ietf-uuidrev-rfc4122bis-10.txt][IETF
